...
import VideoSliderCard from "@/components/VideoSlider";
...
export default function Home() {
  return (
    <div className="w-full bg-gray-100 overflow-x-hidden">
      ...
      {/* Seção principal */}
      <section className="max-w-full flex flex-col md:flex-row items-start justify-between bg-gray-100 px-4 sm:px-8 md:px-12 py-12 gap-10">

        {/* 60% - vem primeiro no mobile */}
        <div className="order-1 md:order-2 w-full md:w-[70%]">
          {/* título 60% */}
          <h2 className="text-xl text-center text-black font-semibold mb-4">Título da Área 60%</h2>
        ...
        <div className="order-2 md:order-1 w-full md:w-[30%]">
          {/* título 40% */}
          <h2 className="text-xl text-center text-black font-semibold mb-4">Produtos / Cards</h2>
